@section('js')
    ...
    <script>
        ...
        const draggableMenu = new Draggable.Draggable(container, {
            draggable: 'li'
        })
        draggableMenu.on('sortable:start', (e) => {
            console.log('Drag dimulai untuk elemen: ', e.data.source);
        });

        draggableMenu.on('sortable:sorted', (e) => {
            console.log('Elemen dipindah ke posisi baru: ', e.data.dragEvent.source);
        });
    </script>
@endsection
