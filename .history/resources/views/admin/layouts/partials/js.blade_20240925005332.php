@section('js')
    ...
    <script>
        ...
        draggable.on('sortable:start', (e) => {
            console.log('Drag started for element: ', e.data.source);
        });

        draggable.on('sortable:sorted', (e) => {
            console.log('Element moved to new position: ', e.data.dragEvent.source);
        });
        ...
        const inputMenuDrag = new Draggable.Sortable(inputMenu, {
            draggable: 'li',
            mirror: {
                constrainDimensions: true,
            },
        ...
        inputMenuDrag.on('sortable:start', (e) => {
            console.log('Drag started for element: ', e.data.source);
        });

        inputMenuDrag.on('sortable:sorted', (e) => {
            console.log('Element moved to new position: ', e.data.dragEvent.source);
        });

        inputMenuDrag.on('sortable:stop', (e) => {
            console.log('Drag stopped');
        });
