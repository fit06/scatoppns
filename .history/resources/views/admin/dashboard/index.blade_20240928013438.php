...
@section('content')
    ...
    <ul class="row" id="dashboardMenu" style="list-style: none">
        <li class="col-md-6 menu-item-dashboard">
    ...
    <button type="button" class="btn btn-primary position-fixed" style="right: 6vh; bottom: 8vh" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Add Conveyor
    </button>
